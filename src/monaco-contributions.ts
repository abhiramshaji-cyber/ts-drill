// Monaco's editor.main pulls in all 90 language tokenizers; this is that file's contribution list only.
// The two .css lines need a relative path: monaco's export map appends .js to every subpath.
